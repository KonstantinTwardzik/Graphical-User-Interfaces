...
public class Main extends Application
{
    ...
    private MainPresenter initApplication(List<String> args) throws IOException
    {
        ...
        mainPresenter.init(mainView, quizPresenter, overviewPresenter, editorPresenter, dialogueView);
        quizPresenter.init(quizView, model);
        overviewPresenter.init(overviewView, model);
        editorPresenter.init(mainPresenter, editorView, model, dialogueView);
